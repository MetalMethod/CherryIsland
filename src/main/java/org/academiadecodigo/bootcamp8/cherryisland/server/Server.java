...
public class Server {
            ...
            while (true) {
                ...
                try {
                    ...
                    if (connectionCount % 2 == 0) {
                        ...
                        for (int i = workers.size() - 2; i < workers.size(); i++) {
                            ServerWorker serverWorker = workers.get(i);
    ...
    private void initGameVars(ArrayList<String> gameObjectInit) {
